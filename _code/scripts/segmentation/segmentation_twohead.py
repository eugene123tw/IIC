...
from _code.utils.cluster.general import config_to_str, get_opt, update_lr, nice
from _code.utils.cluster.transforms import sobel_process
from _code.utils.segmentation.segmentation_eval import \
  segmentation_eval
from _code.utils.segmentation.IID_losses import IID_segmentation_loss, \
  IID_segmentation_loss_uncollapsed
from _code.utils.segmentation.data import segmentation_create_dataloaders
from _code.utils.segmentation.general import set_segmentation_input_channels
...
parser.add_argument("--fine_to_coarse_dict", type=str,  # COCO
                    default="/users/xuji/iid/iid_private/_code/datasets"
...
config.output_k = config.output_k_B  # for eval _code
